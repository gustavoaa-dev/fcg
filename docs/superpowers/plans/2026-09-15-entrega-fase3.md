...
git -C .fase2-repos\fcg-orchestration grep -n -I -E 'Password=FCG@|Fcg2024Test!|fcg-secret-key-2024' origin/master -- . ':!README.md'   # esperado: vazio (o README fica de fora: ele documenta a propria busca e casaria com o padrao)
